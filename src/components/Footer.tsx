      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-xs text-slate-600 dark:text-slate-300">
              <li>• Дизельное топливо ЕВРО-5 Летнее (Сорт C/D)</li>
              <li>• Дизельное топливо ЕВРО-5 Межсезонное (до -20°C)</li>
              <li>• Дизельное топливо ЕВРО-5 Зимнее (до -32°C)</li>
              <li>• Дизельное топливо ЕВРО-5 Арктика (до -50°C)</li>
              <li>• Прямые отгрузки с АО «АНХК» и НПЗ Сибири</li>
            </ul>
          </div>
